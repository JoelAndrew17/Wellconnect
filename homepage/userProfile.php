...
<html class="no-js" lang="zxx">
  ...
  <div class="loader">
    ...
    function logout() {
        // Destroy session via PHP or handle here
        window.location.href = '../client-side/index.html'; // Redirect to the logout PHP page
    }

    // Function to change content on sidebar click
